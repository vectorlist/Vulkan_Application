#include <vertexbufferr.h>



VertexBufferr::VertexBufferr(Window* window)
	: Renderer(window)
{
	//m_vertices = { {0.f,0.f},{1.f,0.0f,0.0f} };
	m_vertices.push_back(Vertex(vec2f(0.0f, -0.5f), Color(0.0f, 0.5f, 0.05f)));
	m_vertices.push_back(Vertex(vec2f(1.0f, 1.0f), Color(1.0f, 0.0f, 0.3f)));
	m_vertices.push_back(Vertex(vec2f(-0.5f,0.5f), Color(0.f, 0.6f, 0.4f)));

}


VertexBufferr::~VertexBufferr()
{
}

void VertexBufferr::buildProcedural()
{
...
void VertexBufferr::buildPipeline()
{
	VkResult err;
...
void VertexBufferr::buildFrameBuffers()
{
...
void VertexBufferr::buildCommandPool()
{
...
void VertexBufferr::buildCommandBuffers()
{
...
void VertexBufferr::buildSemaphores()
{
...
void VertexBufferr::buildVertexBuffers()
{
