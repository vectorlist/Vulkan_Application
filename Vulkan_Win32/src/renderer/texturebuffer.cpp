...
void TextureBuffer::buildTextureImage()
{
	...
	stbi_uc* pixels = stbi_load("./image/checker.jpg", &tex_width, &tex_height, &tex_channels, STBI_rgb_alpha);
...
void TextureBuffer::buildTextureSampler()
{
...
void TextureBuffer::buildDescriptorSetLayout()
{
...
void TextureBuffer::buildDescriptorPool()
{
...
void TextureBuffer::buildDescriptorSet()
{
...
void TextureBuffer::buildUniformBuffer()
{
...
void TextureBuffer::updateUniformBuffer()
{
...
void TextureBuffer::buildPipeline()
{
	VkResult err;
	auto vertCode = vkTool::readfile("./shaders/texturebuffer/vert.spv");
	auto fragCode = vkTool::readfile("./shaders/texturebuffer/frag.spv");
...
void TextureBuffer::buildCommandPool()
{
...
void TextureBuffer::buildCommandBuffers()
{
...
void TextureBuffer::buildSemaphores()
{
...
void TextureBuffer::buildVertexBuffers()
{
...
void TextureBuffer::buildIndiceBuffers()
{
